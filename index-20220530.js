...
app.get('/sensors/11', (req, res) => {
  ...
  var config = {
    method: 'get',
    url: 'https://rguard.ntdigitalsolutions.com/api/province/Bangkok/hourly-aqi?apikey=is6S1G2jT9GvRmMGqesmY07wGsEiA0nY&offset=0&limit=100&from=2022-01-07T06:00:00Z&to=2022-01-07T16:00:00Z',
    headers: {
      ...data.getHeaders()
    },
    data : data
...
.catch(function (error) {
  ...
  var config = {
    ...
    headers: {
      ...
      'X-XSRF-TOKEN': '87424db7-bfe6-4db0-88ce-e600ed266ba',
